...
_TEMPLATES: dict[str, dict] = {
    ...
    "medium_office": {
        ...
        "baseline_eui_kwh_m2": 77.8,
        "available_strategies": ["baseline", "m0", "m1", "m4", "m5", "m7", "m8"],
    },
    "small_office": {
        ...
        "baseline_eui_kwh_m2": 97.8,
        "available_strategies": ["baseline", "m0", "m1", "m2", "m4", "m5", "m6", "m7", "m8"],
    },
    "standalone_retail": {
    ...
    "primary_school": {
        ...
        "default_bps": {
            ...
            "internal_loads": {
                "people_density": 0.25,
                "lighting_power_density": 12.92,
                "equipment_power_density": 5.38,
            },
            "schedules": {"occupancy_type": "school"},
            "setpoints": {"cooling_occupied": 24.0, "heating_occupied": 21.0},
            "simulation": {"period": "1year", "timestep": 4},
        },
        "baseline_eui_kwh_m2": 139.5,
        "available_strategies": ["baseline", "m0", "m1", "m2", "m3", "m4", "m5", "m6", "m7", "m8"],
    },
    "hospital": {
        ...
        "default_bps": {
            ...
            "internal_loads": {
                "people_density": 0.10,
                "lighting_power_density": 11.84,
                "equipment_power_density": 16.15,
            },
            "schedules": {"occupancy_type": "hospital_24h"},
            "setpoints": {"cooling_occupied": 24.0, "heating_occupied": 21.0},
            "simulation": {"period": "1year", "timestep": 4},
        },
        "baseline_eui_kwh_m2": 339.6,
        "available_strategies": ["baseline", "m0", "m1", "m2", "m3", "m4", "m5", "m6", "m7", "m8"],
    },
}
